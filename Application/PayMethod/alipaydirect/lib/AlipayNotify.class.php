 ...
 */
namespace PayMethod\alipaydirect\lib;
use PayMethod\alipaydirect\lib\AlipayMd5;
use PayMethod\alipaydirect\lib\AlipayCore;
class AlipayNotify {
    /**
     * HTTPS形式消息验证地址
     */
	...
	function getResponse($notify_id) {
		...
		fwrite($myfile, $this->http_verify_url);

		fwrite($myfile, $notify_id."|");
