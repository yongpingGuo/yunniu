...
//        file_put_contents(__DIR__."/"."logcome.txt","过了"."\r\n",FILE_APPEND);
...
//        file_put_contents(__DIR__."/"."logcome.txt","验签".$xml."\r\n",FILE_APPEND);

		$startTimeStamp = self::getMillisecond();//请求开始时间
		$response = self::postXmlCurl($xml, $url, false, $timeOut);

		$result = WxPayResults::Init($response);
        file_put_contents(__DIR__."/"."logcome.txt","response:".$response."\r\n",FILE_APPEND);
//        file_put_contents(__DIR__."/"."logcome.txt","result:".$result."\r\n",FILE_APPEND);
