<?php
namespace PayMethod\WxpayMicropay2;
...
//			echo 11;
			return $queryResult = $this->query($out_trade_no, $succResult);
		} else if($result["return_code"] == "SUCCESS" && $result["result_code"] == "FAIL" && $result["err_code"] == "USERPAYING") {
//			echo 22;
			//③、确认支付是否成功
			$queryTimes = 10;
			while ($queryTimes > 0) {
