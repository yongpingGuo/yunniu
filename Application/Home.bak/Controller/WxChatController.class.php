...
//            file_put_contents(LOG_PATH . 'pay_notify.log', var_export($notifyInfo, TRUE));
            ...
            $order_status = M('order')->where(array('order_sn'=>$order_sn))->getField('order_status');
...
//                        $input->SetBody("方雅餐饮系统");
                        ...
                        D('order')->where(array('order_sn'=>$order_sn))->save(array('saoma_out_trade_no'=>$business_order));
