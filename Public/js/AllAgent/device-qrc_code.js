 ...
 */
	...
	function create_code(){
	    ...
	    $.ajax({
	        url:"/index.php/AllAgent/deskQrc/create_code",
	        data:formData,
	        dataType:"json",
	        type:"post",
	        cache:false,
	        ...
	        success:function(msg){
	            if(msg.code == 1){
	            	console.log(msg);
	                layer.msg("生成成功！");
	                self.location.href = "/index.php/AllAgent/deskQrc/qrc_code/page/"+msg.page+".html";
	            }
	        },
	        error:function(){
	            alert("网络错误");
...
function isChange(obj){
    ...
    $.get("/index.php/AllAgent/deskQrc/changeCodeBusiness",{"business_id":business_id,"code_id":code_id},function(msg){
        alert(msg.msg);
    });
}
...
function changeCodeTime(obj){
    ...
    console.log(code_id);
    $.ajax({
        url:'/index.php/AllAgent/deskQrc/changeCodeTime',
	...
	function deleteCode(obj){
	    ...
	    if(confirm("你删除的注册码可能关联着其它设备，是否删除？")){
	        var code_id = $(obj).data("code_id");
	        console.log(code_id);
	        $.getJSON("/index.php/AllAgent/deskQrc/deleteCode",{"code_id":code_id},function(msg){
	            layer.msg(msg.msg);
	            self.location.href="/index.php/AllAgent/deskQrc/qrc_code/page/"+msg.page+".html";
	        });
	    }
	...
	function findInfo(obj){
	    var code_id = $(obj).data("code_id");
	    console.log(code_id);
	    $.get("/index.php/AllAgent/deskQrc/findInfo",{"code_id":code_id},function(msg){
	        console.log(msg);
	    });
	}
        ...
        function batch_delete(){
        	...
        	if(msg == true){
		        ...
		        $.ajax({
		        	type:"get",
		        	url:"/index.php/allAgent/deskQrc/batch_delete/code_id/"+text,
		        	async:true,
		        	dataType:"json",
		        	success:function(data){
		        		if(data.code == 1){
		        			self.location.href="/index.php/AllAgent/deskQrc/qrc_code/page/"+data.page+".html";
		        		}else{
		        			layer.msg(data.msg);
		        		}
		        	}
